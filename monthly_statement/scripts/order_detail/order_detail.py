...
def get_product_num(nature_dict, source, source_by, url, start_timestamp, end_timestamp, start_date_tmp, end_date_tmp):
...
def get_all_data(result_dict, nature_dict, db_aplum, source, costs, source_by, start_date_tmp, end_date_tmp, start_timestamp,
                           end_timestamp):
    ...
    # 商品数
    product_num = int(get_product_num(nature_dict, source, source_by, url, start_timestamp, end_timestamp, start_date_tmp, end_date_tmp))
    ...
    # result_dict['order_costs'] = order_sum_realpayprice
            ...
            for source in source_list:
                ...
                if source in ('CPA', '抖音kol', '微信公众号', '微信朋友圈'):
                    ...
                    if source == 'all':
                        ...
                        result_dict = get_all_data(result_dict, nature_dict, db_aplum, source, costs, source_by, start_date_tmp, end_date_tmp,
