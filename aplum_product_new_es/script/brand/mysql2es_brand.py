...
index1= "aplum_brand_1"
index2= "aplum_brand_2"
aliasIndex = "aplum_brand"
...
if __name__ == '__main__':
    ...
    id = 0
    while (True) :
        sql ="SELECT id, name, alias_name  FROM t_brand b  WHERE id > %d  order by id asc limit 1000" % int(id)
        try:
            cursor.execute(sql)
