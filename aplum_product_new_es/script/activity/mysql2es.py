...
aliasIndex="aplum_activity"
index1= "aplum_activity_a1"
index2= "aplum_activity_a2"
...
if __name__ == '__main__':
    ...
    #update last product_id, activity_id and timestamp
    r.set('last_sync_product_id', id)
    ...
    if len(result) > 0:
        r.set("last_activity_id", int(result['id']))
    ...
    result = cursor.fetchone()
    if len(result) > 0:
        r.set("last_timestamp", str(result['product_update_time']))
