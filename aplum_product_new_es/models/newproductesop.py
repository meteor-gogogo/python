...
from .baseinstance import basenewproduct

class NewProductEsOperator(object):
    def __init__(self, host, user, password, port):
        ...
        self.newproductObj = basenewproduct.BaseNewProduct()
        self.aliasIndex=self.newproductObj.aliasIndex
        self.index1= self.newproductObj.index1
        self.index2= self.newproductObj.index2

    def getAplumNewMapping(self):
        mapping = self.newproductObj.getMapping()
        return mapping
    ...
    def operatorindex(self):
        ...
        try:
            ...
            mapping = self.getAplumNewMapping()
            #删除索引,再创建
