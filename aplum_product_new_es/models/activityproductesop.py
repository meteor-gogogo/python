...
from .baseinstance import baseactivityproduct

class ActivityProductEsOperator(object):
    def __init__(self, host, user, password, port):
        ...
        self.activityproductObj = baseactivityproduct.BaseActivityProduct()
        self.aliasIndex=self.activityproductObj.aliasIndex
        self.index1= self.activityproductObj.index1
        self.index2= self.activityproductObj.index2

    def getMapping(self):
        mapping = self.activityproductObj.getMapping()
        return mapping

    def getAliasIndex(self):
