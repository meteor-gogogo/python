...
from .baseinstance import basebrand

class brandEsOperator(object):
    def __init__(self, host, user, password, port):
        ...
        self.brandObj = basebrand.BaseBrand()
        self.aliasIndex=self.brandObj.aliasIndex
        self.index1= self.brandObj.index1
        self.index2= self.brandObj.index2

    def getMapping(self):
        mapping = self.brandObj.getMapping()
        return mapping
