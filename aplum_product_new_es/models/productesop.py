...
from .baseinstance import baseproduct

class ProductEsOperator(object):
    def __init__(self, host, user, password, port):
        ...
        self.productObj = baseproduct.BaseProduct()
        self.aliasIndex=self.productObj.aliasIndex
        self.index1= self.productObj.index1
        self.index2= self.productObj.index2

    def getMapping(self):
        mapping = self.productObj.getMapping()
        return mapping
